...
- App architecture deep dive: [nflendzoneApp Architecture](/projects/architecture/nflendzoneApp-architecture/)
- Ecosystem architecture (all four repos): [NFL EndZone Ecosystem Architecture](/projects/architecture/nfl-endzone-ecosystem/)
